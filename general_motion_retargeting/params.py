...
ROBOT_XML_DICT = {
    ...
    "minerva_t1": ASSET_ROOT / "minerva_t1" / "t1_robot.xml",
    "t1": ASSET_ROOT / "t1" / "t1_robot.xml",
...
IK_CONFIG_DICT = {
    ...
    "smplx":{
        ...
        "booster_t1_29dof_inspire_custom": IK_CONFIG_ROOT / "smplx_to_booster_t1_29dof_inspire_custom.json",
        "minerva_t1": IK_CONFIG_ROOT / "smplx_to_minerva_t1.json",
        "t1": IK_CONFIG_ROOT / "smplx_to_t1_inspire.json",
